...
const STR = {
    ...
    'set.diff.calm': 'rauhallinen',
    'set.diff.easy': 'helppo',
    'set.diff.normal': 'normaali',
    'set.diffHint': 'Kevyempi taso hidastaa painovoimaa ja työntöä yhtä paljon: peli on sama, aikaa on enemmän. Tippi on kiinni ajasta, joten rauhallisella tasolla myös tienaa vähemmän.',
    'set.sound': 'Ääni',
    'set.on': 'päällä',
    'set.off': 'pois',
    'set.side': 'Napit',
  ...
  en: {
    ...
    'set.title': 'SETTINGS',
    'set.diff': 'Difficulty',
    'set.diff.calm': 'relaxed',
    'set.diff.easy': 'easy',
    'set.diff.normal': 'normal',
    'set.diffHint': 'A lighter setting slows gravity and thrust by the same amount: same game, more time. The tip runs on the clock, so a relaxed shift also pays less.',
    'set.sound': 'Sound',
    'set.on': 'on',
    'set.off': 'off',
    'set.side': 'Buttons',
