...
const STR = {
    ...
    'set.diff.pro': 'pro',
    'set.diffHint': 'Helppo hidastaa painovoimaa ja työntöä yhtä paljon, pro nopeuttaa molempia: peli on sama, aikaa on eri verran. Tippi on kiinni ajasta, joten prolla myös tienaa paremmin.',
    'set.sound': 'Ääni',
    'set.on': 'päällä',
    'set.off': 'pois',
    'set.side': 'Napit',
  ...
  en: {
    ...
    'set.diff.pro': 'pro',
    'set.diffHint': 'Easy slows gravity and thrust by the same amount, pro speeds both up: same game, a different amount of time. The tip runs on the clock, so pro also pays better.',
    'set.sound': 'Sound',
    'set.on': 'on',
    'set.off': 'off',
    'set.side': 'Buttons',
