...
const STR = {
    ...
    'set.title': 'ASETUKSET',
    'set.diff': 'Vaikeustaso',
    'set.diff.easy': 'helppo',
    'set.diff.normal': 'normaali',
    'set.diff.pro': 'pro',
    'set.diffHint': 'Kevyempi taso keventää painovoimaa ja työntöä: peli on sama, aikaa on enemmän ja taksi tottelee paremmin. Helppo leijuu kuten kuukentässä, pro on peli ilman kevennystä. Tippi on kiinni ajasta, joten prolla myös tienaa parhaiten.',
    'set.sound': 'Ääni',
    'set.on': 'päällä',
    'set.off': 'pois',
    'set.side': 'Napit',
    ...
    'menu.p1': 'Nosta alien kyytiin ja vie hänet pyydetylle alustalle. Syaani alusta on kohde, punaiset eivät, ja vihreä pallo kertoo että siellä on jo käyty — sekä nouto että jättö merkkaa alustan. Tippimittari alkaa valua heti noudosta, joten mitä nopeammin perille, sitä isompi tippi — ja laskeudu viereen, älä päälle.',
    ...
    'lost.hint': 'Tippi on kiinni ajasta, ei laskun tyylistä — mutta kova lasku pomppii, ja pomppu maksaa sekunteja.',
  ...
  en: {
    ...
    'set.diff': 'Difficulty',
    'set.diff.easy': 'easy',
    'set.diff.normal': 'normal',
    'set.diff.pro': 'pro',
    'set.diffHint': 'A lighter setting eases gravity and thrust: same game, more time and a more willing taxi. Easy floats like the moon level, pro is the game with no help at all. The tip runs on the clock, so pro also pays best.',
    'set.sound': 'Sound',
    'set.on': 'on',
    'set.off': 'off',
    'set.side': 'Buttons',
    ...
    'set.close': 'Close',
    'menu.t1': 'Space', 'menu.t2': 'Taxi',
    'menu.p1': 'Pick up an alien and fly them to the pad they ask for. Cyan is the target, red pads are not, and a green dot means that pad is already done — both a pickup and a drop-off count. The tip meter starts draining the moment they board, so the faster you get there, the bigger the tip — and land beside your passenger, not on them.',
    ...
    'lost.hint': 'The tip is about time, not landing style — but a hard landing bounces, and bouncing costs seconds.',
