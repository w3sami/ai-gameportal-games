...
const STR = {
    ...
    'set.diff.pro': 'pro',
    'set.diffHint': 'Kevyempi taso hidastaa painovoimaa ja työntöä yhtä paljon: peli on sama, aikaa on enemmän. Pro on peli ilman kevennystä. Tippi on kiinni ajasta, joten prolla myös tienaa parhaiten.',
    'set.sound': 'Ääni',
    'set.on': 'päällä',
    'set.off': 'pois',
    'set.side': 'Napit',
  ...
  en: {
    ...
    'set.diff.pro': 'pro',
    'set.diffHint': 'A lighter setting slows gravity and thrust by the same amount: same game, more time. Pro is the game with no help at all. The tip runs on the clock, so pro also pays best.',
    'set.sound': 'Sound',
    'set.on': 'on',
    'set.off': 'off',
    'set.side': 'Buttons',
